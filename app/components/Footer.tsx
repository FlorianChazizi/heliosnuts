    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div>
          ...
          <p className="text-sm">
          he Dry Nuts Helios company is based in Greece, Larissa city, and trades Greek dry nuts, dried fruits, and snacks since 1986. All products are chosen carefully and packed with responsibility to ensure their high quality and freshness. The purpose of our company is to please and satisfy our customers.          </p>
        </div>
        {/* Column 2 */}
        <div>
